...
export function SectionShell({
  ...
  return (
    <section id={id} className="relative px-[clamp(20px,5cqw,80px)] py-[clamp(64px,10cqw,110px)]" style={bg ? { backgroundColor: bg } : undefined}>
      ...
      <div className="mx-auto max-w-5xl text-center">
        {(subtitle || edit) && (
          <div className="mb-3 font-mono text-[11px] tracking-[.22em] text-mute uppercase">
            <EditableText as="span" edit={edit} value={subtitle} onChange={onSubtitleChange} {...color('subtitle')} {...sizeWeight('subtitle')} />
          </div>
        )}
        <h2 className="mb-10 text-[clamp(32px,4.6cqw,56px)] leading-[.95] font-medium tracking-[-.04em] text-snow">
