...
export function MenuGrid({
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-6 text-left @2xl:grid-cols-2 @5xl:grid-cols-3">
        {data.items.map((item) => (
          <div key={item.id} className="relative overflow-hidden rounded-lg border" style={{ borderColor: 'var(--color-primary)' }}>
            ...
            <div className="p-4">
              <div className="mb-1 flex items-start justify-between gap-2">
                <span className="font-medium" style={{ color: 'var(--color-fog)' }}>
              ...
              <p className="text-sm opacity-70" style={{ color: 'var(--color-fog)' }}>
