...
import { BASE_SECTION_IDS as BASE_IDS, DYNAMIC_SECTION_LABELS, type DynamicSectionType, type SectionLayoutEntry } from '@/lib/types'

import { useEdit } from './EditProvider'

const BASE_SECTION_IDS = new Set<string>(BASE_IDS)
