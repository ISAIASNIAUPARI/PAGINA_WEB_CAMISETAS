      ...
      <div
        ...
        onClick={(e) => {
          ...
          selection?.select(
            ...
            {
              renderControls: () => (
                <div className="relative h-28 rounded-md border border-white/15 bg-black/30">
                  <EditableModel edit onChange={onChange} />
                  <p className="absolute inset-x-2 top-2 text-center text-[11px] leading-snug text-white/55">Archivo .glb optimizado, máximo 40 MB.</p>
                </div>
              ),
            }
          )
